...
$xeco_video_url = function_exists('get_field') ? get_field('fromate_style') : NULL;
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('blog-standard-post blog-details-wrap format-video'); ?>>
        ...
        <?php if (has_post_thumbnail()) : ?>
            <div class="blog-standard-thumb position-relative">
                ...
                <?php if (!empty($xeco_video_url)) : ?>
                    <a href="<?php print esc_url($xeco_video_url); ?>" class="video--icon popup-video"><i class="fas fa-play"></i></a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
