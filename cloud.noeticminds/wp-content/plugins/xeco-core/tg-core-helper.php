...
/**
 * Plugin Name: Xeco Core
 * Description: Xeco elementor core plugin.
 * Plugin URI:  https://www.themegenix.net/
 * Version:     1.0
 * Author:      themegenix
 * Author URI:  https://www.themegenix.net/
 ...
 *
 */
add_filter( 'the_content', 'xeco_shortcode_extra_content_remove' );
/**
 ...
 */
function xeco_shortcode_extra_content_remove( $content ) {
...
final class Genix_Core {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Xeco Core', 'genixcore' ) . '</strong>',
