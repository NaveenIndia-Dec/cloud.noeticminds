...
class Genix_Core_Plugin {
    ...
    public function genix_core_elementor_category($manager)
    {
        $manager->add_category(
            'genixcore',
            array(
                'title' => esc_html__('Xeco Addons', 'genixcore'),
                'icon' => 'eicon-banner',
            )
        );
    }
    ...
    public function genix_add_custom_icons_tab($tabs = array()){
        ...
        $tabs['tg-feather-icons'] = array(
            ...
            'label' => esc_html__('Xeco Feather Icons', 'genixcore'),
        ...
        $tabs['tg-flat-icons'] = array(
            'name' => 'tg-flat-icons',
            'label' => esc_html__('Xeco Flat Icons', 'genixcore'),
            'labelIcon' => 'genix-icon',
            'prefix' => '',
            'displayPrefix' => 'genix',
        ...
        $tabs['tg-fontawesome-icons'] = array(
            ...
            'label' => esc_html__('Xeco Fontawesome Pro', 'genixcore'),
            'labelIcon' => 'genix-icon',
            'prefix' => 'fa-',
            'displayPrefix' => 'fal',
