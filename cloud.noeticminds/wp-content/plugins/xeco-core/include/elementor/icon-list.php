    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('Symbol: CIC', 'genixcore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'repeater_title' => esc_html__('Symbol: CIC', 'genixcore'),
                    ],
                    [
                        'repeater_title' => esc_html__('Initial Value : 1 ETH = 3177.38 CIC', 'genixcore'),
                    ],
                    [
                        'repeater_title' => esc_html__('Type : ERC20', 'genixcore'),
                    ],
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .list-wrap li' => 'text-transform: {{VALUE}};',
                ],
            ]
        );
