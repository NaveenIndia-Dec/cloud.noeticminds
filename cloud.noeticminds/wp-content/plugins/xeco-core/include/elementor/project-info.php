    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => wp_kses_post('Client: <span>David Martin</span>', 'genixcore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'repeater_title' => wp_kses_post('Client: <span>David Martin</span>', 'genixcore'),
                    ],
                    [
                        'repeater_title' => wp_kses_post('Awards: <span>First Place</span>', 'genixcore'),
                    ],
                    [
                        'repeater_title' => wp_kses_post('Production: <span>Codelex Lab</span>', 'genixcore'),
                    ],
                ],
            ]
        );
